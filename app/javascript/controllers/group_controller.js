...
export default class extends Controller {
  ...
  connect() {
    ...
    this.formTarget.classList.add("translate-y-inverse");
  ...
  toggle() {
    if (this.isOpen) {
      ...
      this.formTarget.classList.replace("translate-y-0", "translate-y-inverse");
      ...
      setTimeout(() => {
        this.formTarget.classList.replace("translate-y-inverse", "translate-y-0");
